...
{$ENDIF}
  ...
  TSCardGetStatusChangeA = function(hContext: LongInt; dwTimeout: LongInt;
    var rgReaderStates: SCARD_READERSTATEA;
    cReaders: LongInt): LongInt; stdcall;
  TSCardGetStatusChangeW = function(hContext: LongInt; dwTimeout: LongInt;
    var rgReaderStates: SCARD_READERSTATEW;
    cReaders: LongInt): LongInt; stdcall;
{$IFDEF UNICODE}
...
function SCardGetStatusChangeW(hContext: LongInt;
  dwTimeout: LongInt;
...
type
  ...
  TSCardGetAttrib = function(hCard: LongInt; dwAttrId: LongInt; pbAttr: PByte; var pcbAttrLen: LongInt): LongInt; stdcall;
{$ELSE}
